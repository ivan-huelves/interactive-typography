...
Proyectos catalogados como **Multimodal: No**:
...
<div class="project-grid">
    ...
    <a href="/referentes/aterytool/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/atery 01.jpg" alt="Imagen de AteryTool" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            AteryTool
    ...
    <a href="/referentes/dance-writer/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/dancewriter 01.jpg" alt="Imagen de Dance Writer" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            Dance Writer
    ...
    <a href="/referentes/dmz-life-under-the-shadow-of-a-gun/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/dmz 01.jpg" alt="Imagen de DMZ. Life Under the Shadow of a Gun" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
    ...
    <a href="/referentes/emotxt/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/emotxt 01.jpg" alt="Imagen de Emotxt" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            Emotxt
    ...
    <a href="/referentes/goertek-typeface/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/goertek 01.png" alt="Imagen de Goertek Typeface" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            Goertek Typeface
    ...
    <a href="/referentes/inscript-festival-identity/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/inscript 01.png" alt="Imagen de Inscript Festival Identity" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
    ...
    <a href="/referentes/interactive-typography/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/interactive typography.jpg" alt="Imagen de Interactive Typography" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
    ...
    <a href="/referentes/keyboard-type-control-y-voice-type-control/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/Keyboard Type Control y Voice Type Control 01.png" alt="Imagen de Keyboard Type Control y Voice Type Control" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
    ...
    <a href="/referentes/kinetic-instant-messenger/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/kinetic typography.jpg" alt="Imagen de Kinetic Instant Messenger" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
    ...
    <a href="/referentes/letterspace/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/letterspace 01.jpg" alt="Imagen de Letterspace" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            Letterspace
    ...
    <a href="/referentes/momem/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/momem.jpg" alt="Imagen de Momem" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            Momem
    ...
    <a href="/referentes/no-design-foundry-tools/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/no design foundry 01.png" alt="Imagen de no design foundry Tools" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
    ...
    <a href="/referentes/nomad-typeface/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/nomad typeface.jpg" alt="Imagen de Nomad Typeface" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            Nomad Typeface
    ...
    <a href="/referentes/phonoma/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/phonoma.jpg" alt="Imagen de Phonoma" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            Phonoma
    ...
    <a href="/referentes/reactive-typography/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/Reactive Typography 1.png" alt="Imagen de Reactive Typography" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            Reactive Typography
    ...
    <a href="/referentes/sonictype/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/sonyctype 01.jpg" alt="Imagen de Sonictype" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            Sonictype
    ...
    <a href="/referentes/still-standing/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/still standing 01.jpg" alt="Imagen de Still Standing" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            Still Standing
    ...
    <a href="/referentes/takeluma/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/takeluma 01.jpg" alt="Imagen de Takeluma" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            Takeluma
    ...
    <a href="/referentes/timed-type/" class="project-card">
      <div class="card-image">
        <img src="/images/referentes/timed type.jpg" alt="Imagen de Timed Type" loading="lazy">
      </div>
      <div class="card-content">
        <span class="card-title" style="display:block; font-weight:bold; margin-bottom:0.5rem;">
            Timed Type
